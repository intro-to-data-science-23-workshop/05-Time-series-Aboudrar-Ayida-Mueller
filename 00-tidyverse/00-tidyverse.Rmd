...
1. *Index* : We should understand easily what is the index and it should be easy to extract this information. 

2. *Key* : There can be one or more variable identifying the entities being measured within the dataset. Defining a key is especially important when the dataset contains multiple types of entities. It allows to describe the specific characteristics that make each type of entity unique. 
