...
The existing integration of modeling and the tidyverse is especially problematic for time series, as the input data structure(s) is/are inherently untidy. 
